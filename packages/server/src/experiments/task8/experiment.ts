...
export async function runTrialBody(ctx: TrialContext): Promise<void> {
  ...
  // Task8 is a behavior-only pilot. Keep questionnaire plumbing intact in
  // the app/agent, but do not show or wait for questionnaire screens here.
  const needsQuestionnaire = false;
